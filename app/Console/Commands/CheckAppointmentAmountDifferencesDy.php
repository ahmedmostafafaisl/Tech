...
class CheckAppointmentAmountDifferencesDy extends Command
{
    /**
     * The name and signature of the console command.
     *
     * You can run it like: php artisan appointments:check-differences-dy
     */
    protected $signature = 'appointments:check-differences-dy {appointments*}';
    ...
    {
        // Get dynamic input from command
        $appointments = $this->argument('appointments');
