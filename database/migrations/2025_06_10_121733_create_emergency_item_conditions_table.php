...
return new class extends Migration
{
    ...
    {
        Schema::create('emergency_item_conditions', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('emergency_main_item_id')->index();
    ...
    {
        Schema::dropIfExists('emergency_item_conditions');
    }
};
