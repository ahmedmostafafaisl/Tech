...
return new class extends Migration
{
    ...
    {
        Schema::create('periodic_main_item_parts', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('appointment_id');
            $table->unsignedBigInteger('periodic_main_item_id')->nullable();
    ...
    {
        Schema::dropIfExists('periodic_main_item_parts');
    }
};
