...
return new class extends Migration
{
    ...
    {
        Schema::create('emergency_main_item_parts', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('appointment_id');
            $table->unsignedBigInteger('emergency_main_item_id')->nullable();
    ...
    {
        Schema::dropIfExists('emergency_main_item_parts');
    }
};
